...
var fileDescriptor_ad098daeda4239f7 = []byte{
	...
	0x4b, 0x2d, 0xd2, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x05, 0x53, 0x4a, 0xb2, 0x5c, 0xdc,
	0xa1, 0xc5, 0xa9, 0x45, 0x41, 0xa9, 0x85, 0xa5, 0xa9, 0xc5, 0x25, 0x42, 0x7c, 0x5c, 0x4c, 0x99,
	0x29, 0x12, 0x8c, 0x0a, 0x8c, 0x1a, 0x9c, 0x41, 0x4c, 0x99, 0x29, 0x4a, 0x1a, 0x5c, 0x3c, 0x10,
	0xe9, 0xe2, 0x82, 0xfc, 0xbc, 0xe2, 0x54, 0x21, 0x09, 0x2e, 0xf6, 0xdc, 0xd4, 0xe2, 0xe2, 0xc4,
	0xf4, 0x54, 0xa8, 0x22, 0x18, 0xd7, 0xc8, 0x81, 0x8b, 0x03, 0xa4, 0xd2, 0x33, 0x2f, 0x2d, 0x5f,
	0xc8, 0x84, 0x8b, 0xdd, 0x3d, 0xb5, 0x04, 0xc4, 0x15, 0x12, 0x82, 0x58, 0xa7, 0x87, 0x64, 0x89,
	0x94, 0x30, 0x8a, 0x18, 0xc4, 0x64, 0x25, 0x86, 0x24, 0x36, 0xb0, 0xa8, 0x31, 0x20, 0x00, 0x00,
	0xff, 0xff, 0xe0, 0xfd, 0xba, 0x94, 0xa8, 0x00, 0x00, 0x00,
}
...
func (c *userInfoClient) GetUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
	err := c.cc.Invoke(ctx, "/proto.UserInfo/GetUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedUserInfoServer) GetUser(ctx context.Context, req *UserRequest) (*UserResponse, error) {
...
func _UserInfo_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.UserInfo/GetUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserInfoServer).GetUser(ctx, req.(*UserRequest))
	}
